...
public class WSServiciosHR extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(pe.gob.mtc.wshr.WSServiciosHR.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = pe.gob.mtc.wshr.WSServiciosHR.class.getResource(".");
			url = new URL(baseUrl,
					"http://pruebawshr.mtc.gob.pe/wsServiciosHR.asmx?WSDL");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://pruebawshr.mtc.gob.pe/wsServiciosHR.asmx?WSDL', retrying as a local file");
