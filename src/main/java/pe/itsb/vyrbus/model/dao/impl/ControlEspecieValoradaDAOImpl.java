...
//			controlEspecieValorada.setControlEspecieValoradaID(controlEspecieValoradaID);
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.ControlEspecieValoradaDAO#eliminarSecuenciador(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.ControlEspecieValoradaDAO#ejecutarSecuenciador(pe.itsb.vyrbus.model.bean.ControlEspecieValorada)
	 */
	@Override
