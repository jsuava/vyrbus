...
public class GastoDAOImpl extends GenericDAOImpl implements GastoDAO {
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.GastoDAO#buscarGasto(java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
...
//					"WHERE lq.agencia_id="+idAgencia+" AND lq.usuario_id="+idUsuario+" AND to_char(lq.d_fecliq,'dd/mm/yyyy')=to_date('"+fecha+"','"+Constantes.DATE_FORMAT+"') ";
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.GastoDAO#obtenerGastosByLiquidacion(java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	public List<Gasto> obtenerGastosByLiquidacion(String fechaLiquidacion, Integer idAgencia, Integer idUsuario, Integer isIngreso, Boolean groupByObs) {
		...
		}else if(groupByObs!=null && !groupByObs) {
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.GastoDAO#buscarGastosIngresos(java.lang.String, java.lang.String, java.lang.Integer)
	 */
	@Override
