 ...
 *
 */
public interface LineaCreditoClienteDAO extends GenericDAO {
	...
	/**
	 * Busca el historial o las solcitudes por Linea de credito pendientes por aprobar del Nivel 2.(Coresponde al área de Finanzas)
