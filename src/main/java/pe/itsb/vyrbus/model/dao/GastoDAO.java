...
public interface GastoDAO extends GenericDAO {
	...
	/**
	 * Busca Gastos de liquidaci�n de turno
	 * @param fechaGasto :Fecha emisi�n del gasto
	...
	/**
	 * Busca Gastos de liquidaci�n de turno de forma resumida
	 * @param fechaGasto 	:Fecha inicio de emisi�n del gasto
	 * @param fechaFinGasto	:Fecha fin de emisi�n del gasto
	 * @param idTipoGasto	:identificador del tipo de gasto
	 * @param idAgencia	 	:identidficador de la agencia
	 ...
	 * @param fecha		: Fecha de la liquidaci�n
	 * @param idUsuario	: Identicador del usuario
	 * @param idAgencia	: Identificador de la agencia
	 * @return	suma total de tdos los gastos ingresados a la liquidaci�n
	 * @throws Exception
	 */
	 ...
	 * @param idAgencia			: Identificador de la agencia
	 * @param idUsuario			: Identificador del usuario due�o de liquidacion
