...
public interface GastoDAO extends GenericDAO {
	...
	/**
	 * Busca Gastos de liquidaciï¿½n de turno
	 * @param fechaGasto :Fecha emisiï¿½n del gasto
	...
	/**
	 * Busca Gastos de liquidaciï¿½n de turno de forma resumida
	 * @param fechaGasto 	:Fecha inicio de emisiï¿½n del gasto
	 * @param fechaFinGasto	:Fecha fin de emisiï¿½n del gasto
	 * @param idTipoGasto	:identificador del tipo de gasto
	 * @param idAgencia	 	:identidficador de la agencia
	 ...
	 * @param fecha		: Fecha de la liquidaciï¿½n
	 * @param idUsuario	: Identicador del usuario
	 * @param idAgencia	: Identificador de la agencia
	 * @return	suma total de tdos los gastos ingresados a la liquidaciï¿½n
	 * @throws Exception
	 */
	 ...
	 * @param idAgencia			: Identificador de la agencia
	 * @param idUsuario			: Identificador del usuario dueï¿½o de liquidacion
