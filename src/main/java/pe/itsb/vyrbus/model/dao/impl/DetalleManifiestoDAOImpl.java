...
public class DetalleManifiestoDAOImpl extends GenericDAOImpl implements DetalleManifiestoDAO {
	...
	public List<DetalleManifiesto> buscarPasajeros(Long idManifiesto,Integer idLocalidadOrigen, Integer idAgenciaPuntoEmbarque)throws Exception {
		String sql="SELECT vp.venpas_id "+ // 0
					      ...
					      ",a.c_nomcor "+  // 15
					      ",dm.manifiesto_id "+ //16
					      ",ae.agencia_id AS agencia_idEmbarcado "+ //17 - Representa el idAgencia donde realiz� el embarque
					      ",dm.audfecmod as FechaDesp "+ //18 - Representa la fecha y hora en que se realiz� el despacho
					      ",dm.audusumod as usuarioDespacho "+ //19  - Representa el usuario que realizo el despacho.
					      ",ae.c_nomcor AS agencia_NombreEmbarcado "+ //20 - Representa el nombre corto de la agencia donde realiz� el embarque
					"FROM VRTDETMAN dm "+
...
//					   "AND dm.agencia_id IS NULL " +
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.DetalleManifiestoDAO#quitarManifiesto(java.lang.Long)
	 */
	@Override
