...
public class AgenciaDAOImpl extends GenericDAOImpl implements AgenciaDAO {
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.AgenciaDAO#buscarAgenciaByLocalidad(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.model.dao.AgenciaDAO#buscarAgencia_Idvyrbus(java.lang.Integer)
	 */
	@Override
