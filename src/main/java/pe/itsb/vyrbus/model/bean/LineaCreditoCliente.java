...
public class LineaCreditoCliente extends GenericBean {
	...
	private String estadoLineaCredito;
	...
	public String getEstadoLineaCredito() {
		return estadoLineaCredito;
	}
	public void setEstadoLineaCredito(String estadoLineaCredito) {
		this.estadoLineaCredito = estadoLineaCredito;
	}
