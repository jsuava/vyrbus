 ...
 * Descripci�n	: Permite la comunicaci�n entre la capa de la vista el la capa del negocio
 * 				  Responsable de cargar e inspeccionar los benas definidos en el ApplicationContext.xml.
 * Autor		: Jos� Avalos
 * Fecha		: 28/09/2012
 */
package pe.itsb.vyrbus.service.locator;
...
public class ServiceLocator {
	...
	/**
	 * Obtiene el bean de UsuarioHardware, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 *  Obtiene el bean de Motivocortecia, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 *  Obtiene el bean de Manifiesto, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de Rol, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de UsuarioRol, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de OpcionMenu, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de RolOpcionMenuManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de GastoManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de LiquidacionBusManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de GastoBusManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de LiquidacionManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de DetalleLiquidacionManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de LiquidacionOficinaManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de TransbordoManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de ReportesManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de autorizadorCortesia, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de SolicitudCarteraManajer, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de SolicitudClienteCreditoManger, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de TipoCobranzaManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de CarteraClienteManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de UsuarioAprobadorManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de LineaContadoClienteManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de LineaCreditoClienteManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de MotivoTemporadaAltaManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de TemporadaAltaManager, para realizar la comunicaci�n con la capa modelo.
	...
	/**
	 * Obtiene el bean de PuntosPasajeroFrecuenteManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de ParametrosManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de HistoricoMembresiaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de OcupacionAsientosDesbloqueadosManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de ReniecManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de HistoricoControlEspecieValoradaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de CentroCostoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TerminosVentaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de DetalleManifiestoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de SerieEspecieValoradaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaFechaAbiertaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de VentaSeguroManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de MTCRutaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de MTCDireccionTerminalManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de MTCDetalleRutaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de HREManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de DetalleFlotaHREManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TitanManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de VentaTramoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de RangoSobregiroManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de ConfiguracionImpresoraManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de DestinatariosEmailsManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoCentroCostoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoCambioManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoMonedaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de SessionManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de ReimpresionAnticipadaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaClienteManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaClienteDetalleManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoAsientoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de LocalidadIntegracionManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de VentaPoolManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de OcupacionAsientosBloqueadosPoolManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoNotaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de EmbarquePasajeroManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de DetalleEmbarquePasajeroManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TipoPrecioManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de DetalleButacaManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de ComprobantesBloqueadosManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TranscarManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TranscarWebManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de FlagManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de CuponPromocionalManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaByAsientoPlantillaEncabezadoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaByAsientoManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaByAsientoDetalleManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaByAsientoPlantillaEncabezadoDetalleManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de TarifaByAsientoPlantillaPromocionManager, para realizar la comunicaci�n con la capa modelo
	...
	/**
	 * Obtiene el bean de MovimientoPasajesManager, para realizar la comunicaci�n con la capa modelo
	 * @return <b>MovimientoPasajesManager</b>
	 */
	public static MovimientoPasajesManager getMovimientoPasajesManager(){
		return (MovimientoPasajesManager) SpringUtil.getBean("movimientoPasajesManager",MovimientoPasajesManager.class);
	}
}
