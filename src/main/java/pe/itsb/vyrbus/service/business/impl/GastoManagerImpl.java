...
import pe.itsb.vyrbus.model.dao.GastoDAO;
import pe.itsb.vyrbus.service.business.GastoManager;
/**
 *
 * @author Jos� Abanto
 *
...
public class GastoManagerImpl implements GastoManager {
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.GastoManager#buscarGasto(java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	public List<Gasto> buscarGastoResumen(String fechaIniGasto, String fechaFinGasto, Integer idTipoGasto, Integer idAgencia, Integer idUsuario) {
		// TODO Auto-generated method stub
		return getGastoDAO().buscarGastoResumen(fechaIniGasto, fechaFinGasto, idTipoGasto, idAgencia, idUsuario);
	}
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.GastoManager#obtenerGastosByLiquidacion(java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.GastoManager#buscarGastosIngresos(java.lang.String, java.lang.String, java.lang.Integer)
	 */
	@Override
