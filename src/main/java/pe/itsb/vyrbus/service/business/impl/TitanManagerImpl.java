...
import pe.itsb.vyrbus.service.business.TitanManager;
...
public class TitanManagerImpl implements TitanManager {
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.TitanManager#guardarUsuarioHardware(pe.itsb.vyrbus.model.bean.TitanUsuarioHardware)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.TitanManager#buscarUsuarioHardwareByIdVyR(java.lang.String)
	 */
	@Override
