 ...
 *
 */
public interface VentaSeguroManager {
	...
	/**
	 * Busca asignacion de certificados
	 * @return lista de certificados asignados
	 * @throws Exception
	 */
	public List<VSAsignacionCertificados>buscarAsignacionCertificados()throws Exception;
	/**
	 * Guarda la asignacion de certificados.
	 * @param vsAsignacionCertificados	: Nueva instancia del objeto a guardar.
	 * @throws Exception
	 */
	public void guardarAsignacionCertificados(VSAsignacionCertificados vsAsignacionCertificados)throws Exception;
	/**
	 * Actualiza la asignacion de certificados
	 * @param vsAsignacionCertificados
	 * @throws Exception
	 */
