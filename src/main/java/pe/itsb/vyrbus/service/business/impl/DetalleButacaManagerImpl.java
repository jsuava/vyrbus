...
import pe.itsb.vyrbus.service.business.DetalleButacaManager;
 ...
 *
 */
public class DetalleButacaManagerImpl implements DetalleButacaManager{
	private DetalleButacaDAO detalleButacaDAO;

	/**
	 * @return the detalleButacaDAO
	 */
	public DetalleButacaDAO getDetalleButacaDAO() {
		return detalleButacaDAO;
	}

	/**
	 * @param detalleButacaDAO the detalleButacaDAO to set
	 */
	public void setDetalleButacaDAO(DetalleButacaDAO detalleButacaDAO) {
		this.detalleButacaDAO = detalleButacaDAO;
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#buscarPorEstadoRegistro(java.lang.String, java.lang.String)
	 */
	@Override
	public ArrayList<DetalleButaca> buscarPorEstadoRegistro(String estado,String criterioOrden) {
		// TODO Auto-generated method stub
		return getDetalleButacaDAO().buscarPorEstadoRegistro(estado, criterioOrden);
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#buscarPorX(java.util.TreeMap, java.util.List)
	 */
	@Override
	public ArrayList<DetalleButaca> buscarPorX(TreeMap<String, Object> criteriosBusqueda,List<String> criteriosOrdenar) {
		// TODO Auto-generated method stub
		return getDetalleButacaDAO().buscarPorX(criteriosBusqueda, criteriosOrdenar);
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#buscarPorId(java.lang.Long)
	 */
	@Override
	public DetalleButaca buscarPorId(Long id) {
		// TODO Auto-generated method stub
		return getDetalleButacaDAO().buscarPorId(id);
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#guardar(com.tepsa.sisvyr.model.bean.DetalleButaca)
	 */
	@Transactional
	@Override
	public void guardar(DetalleButaca detalleButaca) {
		// TODO Auto-generated method stub
		getDetalleButacaDAO().guardar(detalleButaca);
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#actualizar(com.tepsa.sisvyr.model.bean.DetalleButaca)
	 */
	@Transactional
	@Override
	public void actualizar(DetalleButaca detalleButaca) {
		// TODO Auto-generated method stub
		getDetalleButacaDAO().actualizar(detalleButaca);
	}

	/* (non-Javadoc)
	 * @see com.tepsa.sisvyr.service.business.DetalleButacaManager#inactivar(java.lang.Long)
	 */
	@Override
