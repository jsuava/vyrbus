...
import pe.itsb.vyrbus.model.bean.TitanLiquidacionTurnoPasaje;
import pe.itsb.vyrbus.model.bean.TitanVentaPasaje;
...
import pe.itsb.vyrbus.model.dao.TitanDAO;
...
import pe.itsb.vyrbus.service.business.VentaPasajesManager;
...
import pe.itsb.vyrbus.service.util.Sendmail;
...
//						ventaPasaje.setNumeroBoleto(especieValorada.toString());
					...
					if(!(ventaPasaje.getServicioEspecialFactura())){ //Solo se omite esta validaci�n en el caso de los servicios especiales con Factura.
...
//					Long correlativo = Long.valueOf(ventaPasaje.getNumeroBoleto().substring(position+1))+1;
					...
					/* Valida el tipo de comprobante para en funci�n a ello actualizar el correlativo - 14/10/2013-jabanto */
//					if(ventaPasaje.getTipoComprobante().getId().intValue()==Constantes.ID_TIPCOM_BOLETO_VIAJE)
...
//		}
		...
		//Cuando es una anulaci�n de una ida y vuelta.
...
//	}
	...
	/**
	 * Realiza la anulaci�n de los puntos asociados a una venta.
...
//			getEspecieValoradaDAO().update(especieValorada);
		...
		/*	Realizando la anulaci�n del boleto despues de la reimpresion	*/
...
//						TitanDAOImpl getTitanDAO=new TitanDAOImpl();
				...
				if(liquidacionTurnoPasaje!=null){
					...
					throw new Exception("No se ha encontrado la transferencia de la Liquidaci�n, \n" +
										"por lo que no se pudo hacer el recalculo en los totales de Boletos Cr�dito en la liquidaci�n de turno en TITAN. ");
				}
				...
				if(titanVentaPasaje!=null){
					...
					throw new Exception("El Boleto esta como transferido en el Sisvyr, sin embargo �ste no ha sido encontrado en TITAN");
				}
				...
				if(titanVentaPasaje.getFechaTransferencia()!=null){
					//Envia correo
					try{
						String title="Anulaci�n Boleto Cr�dito";
						String toAddress="sistemas@tepsa.com.pe";
//								String mensaje="Se ha realizado la anulaci�n del Siguiente Boleto, el cual ya ha sido transferidos al OFISIS.\n\n";
						String mensaje="Se ha realizado la anulaci�n del Siguiente Boleto, el cual ya fue transferido al OFISIS.\n\n";

						mensaje+="Nro. Boleto   : "+boleto.getNumeroBoleto()+"\n";
						mensaje+="Fecha Emisi�n : "+Constantes.FORMAT_DATE.format(boleto.getFechaLiquidacion())+"\n";
						mensaje+="Fecha Transferencia : "+Constantes.FORMAT_DATE.format(titanVentaPasaje.getFechaTransferencia())+"\n";

						mensaje+="\n\n";
						mensaje+="NOTA: [Este buzon es de envio autom�tico, por favor no responda.]";
...
//		getEspecieValoradaDAO().update(especieValorada);
	...
	public VentaPasaje generarNotaCredito(VentaPasaje ventaAplica, TipoNota tipoNota, boolean anularMovimiento, boolean copyCanalOriginal) throws Exception {
		return generarNotaCredito(ventaAplica, tipoNota, anularMovimiento, copyCanalOriginal, null);
	}
	/*
	 * (non-Javadoc)
...
//				newComprobante.setTipoMovimiento(new TipoMovimiento(Constantes.ID_TIPMOV_REGULACION));
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarAvanceVentas(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarBoletosAnuladosByX(java.lang.String, java.lang.String, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarBoletosAnuladosDetalladoByX(java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarBoletosPostergadosByX(java.lang.String, java.lang.String, java.lang.Integer)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#procesarAnulacionServicioEspecial(java.util.List, int, boolean, pe.itsb.vyrbus.model.bean.Liquidacion)
	 */
	@Override
	@Transactional
...
//			}
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarFacturasServicioEspecial(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarVentasPagoPilotos(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarBoletosPerdidaServicio(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#guardarPerdidaServicio(java.lang.Long, java.lang.String)
	 */
	@Transactional
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarLiquidacionBus(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#buscarEquivalenciaEntidades(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.service.business.VentaPasajesManager#postergarFAMasivo(java.util.List)
	 */
	@Override
	@Transactional
