...
public interface LiquidacionManager {
	...
	/**
	 * Buscar por el idenficador de la entidad
	...
	/**
	 * Busca los boletos vendidos por Tuentrada y devuelve la estructura necesaria para mostrar la informaci�n.
	 * @param idAgencia			: Identificador de la agencia.
	 * @param idUsuario			: Identificador del usuario.
	 * @param fechaliquidacion	: Fecha de la liquidacion.
	 * @return
