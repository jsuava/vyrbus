...
import pe.itsb.vyrbus.service.exceptions.AddressEmailInvalidException;
import pe.itsb.vyrbus.service.exceptions.SocketMessagingException;
...
//	        texto.setText("Documentos que vencer�n");
...
//	        t.sendMessage(message,message.getAllRecipients());
	...
	/**
     * M�todo p�blico y est�tico que env�a un correo a las direcciones
     * indicadas en el fichero de propiedades, desde la direcci�n indicada
     * tambi�n en el mismo fichero con el asunto y el contenido que se pasan
     * como par�metros.
     *
	...
	/**
     * M�todo para inicializar los valores del seridor de correo,
     * se cargan desde un fichero de configuraci�n con los siguientes valores:
	...
	public static void init () {
		try{
	        ...
	        System.out.println( "No hay informaci�n de arranque!!" );
	        System.exit( -2 );
	    }
	}
}
