...
import pe.itsb.vyrbus.service.fe.ArrayOfDetalleVenta;
import pe.itsb.vyrbus.service.fe.ArrayOfInformacionAdicionalPropiedadAdicional;
import pe.itsb.vyrbus.service.fe.ArrayOfInformacionAdicionalTotalMonedaAdicional;
import pe.itsb.vyrbus.service.fe.ArrayOfInformacionCredito;
import pe.itsb.vyrbus.service.fe.Cliente;
import pe.itsb.vyrbus.service.fe.DetalleVenta;
import pe.itsb.vyrbus.service.fe.DocumentoBaja;
import pe.itsb.vyrbus.service.fe.DocumentoReferencia;
import pe.itsb.vyrbus.service.fe.IMEFEService;
import pe.itsb.vyrbus.service.fe.InformacionAdicional;
import pe.itsb.vyrbus.service.fe.InformacionAdicionalPropiedadAdicional;
import pe.itsb.vyrbus.service.fe.InformacionAdicionalTotalMonedaAdicional;
import pe.itsb.vyrbus.service.fe.InformacionCredito;
import pe.itsb.vyrbus.service.fe.MEFEService;
import pe.itsb.vyrbus.service.fe.Nota;
import pe.itsb.vyrbus.service.fe.Result;
import pe.itsb.vyrbus.service.fe.Venta;
import pe.itsb.vyrbus.service.locator.ServiceLocator;
import pe.itsb.vyrbus.service.mappers.ResumenComprobante;
import pe.itsb.vyrbus.service.xml.XmlCliente;
import pe.itsb.vyrbus.service.xml.XmlConfigPrint;
import pe.itsb.vyrbus.service.xml.XmlDetalleLiquidacionEgresos;
import pe.itsb.vyrbus.service.xml.XmlDetalleLiquidacionIngresoVenta;
import pe.itsb.vyrbus.service.xml.XmlDetalleLiquidacionOtrosIngresos;
import pe.itsb.vyrbus.service.xml.XmlDetalleVentaPasajes;
import pe.itsb.vyrbus.service.xml.XmlEquipaje;
import pe.itsb.vyrbus.service.xml.XmlEquipajes;
import pe.itsb.vyrbus.service.xml.XmlItem;
import pe.itsb.vyrbus.service.xml.XmlItemEgresoLiquidacion;
import pe.itsb.vyrbus.service.xml.XmlItemIngresoVentaLiquidacion;
import pe.itsb.vyrbus.service.xml.XmlItemOtroIngresoLiquidacion;
import pe.itsb.vyrbus.service.xml.XmlLiquidacion;
import pe.itsb.vyrbus.service.xml.XmlLiquidacionTuentrada;
import pe.itsb.vyrbus.service.xml.XmlPasajero;
import pe.itsb.vyrbus.service.xml.XmlVenta;
import pe.itsb.vyrbus.service.xml.XmlVentaPasaje;
...
//			System.setProperty("http.proxyPort", "8080");
	...
	public static Result anularComprobante(VentaPasaje ventaAnular)throws Exception{
		...
		documentoBaja.setNumeroSerie(new JAXBElement<>(new QName(NAMESPACE,"numeroSerie"), String.class, serie));
		documentoBaja.setTipoDocumentoID(new JAXBElement<>(new QName(NAMESPACE,"tipoDocumentoID"), String.class, tipoComprobante));
		documentoBaja.setUsuarioID(ventaAnular.getAgencia().getId().longValue());
		documentoBaja.setUsuarioModificacion(new JAXBElement<>(new QName(NAMESPACE,"usuarioModificacion"), String.class, ventaAnular.getUsuarioModificacion()));
...
//			xmlLiquidacion.setV4_ingresoTotalEfectivo(totalEfectivo.toString());
			...
			if(lstOtrosIngresos.size()>0) {
				List<XmlItemOtroIngresoLiquidacion> lstItemOtrosIngresos= new ArrayList<>();
			...
			List<XmlItemEgresoLiquidacion> lstEgresos = new ArrayList<>();
...
//			lstEgresos.add(new XmlItemEgresoLiquidacion("CREDITO", "", "", cantidadCredito.toString(), totalCredito.toString()));
			...
			lstEgresos.add(new XmlItemEgresoLiquidacion("VTA. TARJETA", "", "", Integer.toString(cantidadVentaTarjeta), Double.toString(montoVentaTarjeta)));
...
//						xmlVenta.setV992_CentroCosto(ventaPasaje.getCentroCosto().getCodigo()+" - "+ventaPasaje.getCentroCosto().getDenominacion());
			...
			if(listXmlVenta.size()>0){
				...
				List<XmlVenta> listXmlCopyAdicional = new ArrayList<>();
...
//			String fechaEmision=FORMAT_DATE.format(ventaPasaje.getFechaLiquidacion());
			...
			cliente.setNombres(new JAXBElement<>(new QName(NAMESPACE,"nombres"), String.class, cliente_nombres));
			cliente.setTipoDocumentoID(new JAXBElement<>(new QName(NAMESPACE,"tipoDocumentoID"), String.class, cliente_tipoDocumentoID));
			cliente.setNumeroDocumento(new JAXBElement<>(new QName(NAMESPACE,"numeroDocumento"), String.class, cliente_nroDocumento));
			...
			venta.setFechaEmision(new JAXBElement<>(new QName(NAMESPACE,"fechaEmision"), String.class, fechaEmision));
			...
			venta.setCliente(new JAXBElement<>(new QName(NAMESPACE,"cliente"), Cliente.class, cliente));
			venta.setAgenciaID(ventaPasaje.getAgencia().getId().longValue());
			venta.setUsuarioID(ventaPasaje.getUsuario().getId().longValue());
			venta.setUsuarioInsercion(new JAXBElement<>(new QName(NAMESPACE,"usuarioInsercion"), String.class, ventaPasaje.getUsuarioInsercion()));
			venta.setUsuarioModificacion(new JAXBElement<>(new QName(NAMESPACE,"usuarioModificacion"), String.class, ventaPasaje.getUsuarioInsercion()));
			...
			case Constantes.ID_FORPAG_CORTESIA:
				...
				venta.setObservaciones(new JAXBElement<>(new QName(NAMESPACE,"observaciones"), String.class, observaciones));
				break;
			default:
			...
			if(ventaPasaje.getCentroCosto()!=null){
				...
				venta.setCentroCosto(new JAXBElement<>(new QName(NAMESPACE,"centroCosto"), String.class, centroCosto));
			}
			/*Comprobante referencial*/
			if(ventaPasaje.getNumeroBoletoAnterior()!=null){
				DocumentoReferencia documentoReferencia= new DocumentoReferencia();
				documentoReferencia.setNumeroDocumento(new JAXBElement<>(new QName(NAMESPACE,"NumeroDocumento"), String.class, ventaPasaje.getNumeroBoletoAnterior()));
				venta.setDocumentoReferencia(new JAXBElement<>(new QName(NAMESPACE,"documentoReferencia"), DocumentoReferencia.class, documentoReferencia));
			}
			...
			if(ventaPasaje.getTipoTransaccion().equals(Constantes.TIPO_OPERACION_VENTA_POOL)){
				...
				if(direccionEmbarque==null)
					direccionEmbarque="****";
				venta.setDireccionEmbarque(new JAXBElement<>(new QName(NAMESPACE,"direccionEmbarque"), String.class, direccionEmbarque));
			}else{
				if(ventaPasaje.getAgenciaPartida()!=null){
					Agencia agenciaPartida=ventaPasaje.getAgenciaPartida();
					if(agenciaPartida.getDireccion()==null)
						agenciaPartida=ServiceLocator.getAgenciaManager().buscarPorId(agenciaPartida.getId().longValue());
					venta.setDireccionEmbarque(new JAXBElement<>(new QName(NAMESPACE,"direccionEmbarque"), String.class, agenciaPartida.getDireccion()));
				}
			}
			...
			if(ventaPasaje.getTipoCobranza()!=null) {
				...
				informacionCredito.setNroCuota(new JAXBElement<>(new QName(NAMESPACE,"NroCuota"), String.class, "Cuota001"));
				informacionCredito.setMontoCuota(BigDecimal.valueOf(ventaPasaje.getImportePagado()));
				informacionCredito.setFechaVencimiento(new JAXBElement<>(new QName(NAMESPACE,"FechaVencimiento"), String.class, strFechaVencimiento));
//				venta.setFechaEmision(new JAXBElement<String>(new QName(NAMESPACE,"fechaEmision"), String.class, fechaEmision));
				...
				venta.setInfoCreditList(new JAXBElement<>(new QName(NAMESPACE,"InfoCreditList"), ArrayOfInformacionCredito.class,arrayOfInformacionCredito));
...
//			Double totalOpGratuitas=.00;
			...
			venta.setListDetalleVenta(new JAXBElement<>(new QName(NAMESPACE,"listDetalleVenta"), ArrayOfDetalleVenta.class,arrayOfDetalleVenta));
			...
			if(venta.getIgv()!=null && venta.getIgv().doubleValue()>0.00){
				totalMonedaAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1001")); /*Segun catalogo 14*/
				totalMonedaAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "TOTAL VALOR DE VENTA - OPERACIONES GRAVADAS"));
			}else{
				totalMonedaAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1003")); /*Segun catalogo 14*/
				totalMonedaAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "TOTAL VALOR DE VENTA - OPERACIONES EXONERADAS"));
			}
			totalMonedaAdicional.setValor(new JAXBElement<>(new QName(NAMESPACE,"valor"), String.class, Util.toNumberFormat(venta.getMontoSubTotal(),2))); /*(no incluye impuesto)*/
			...
			if(isCortesia){
				...
				totalMonedaAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1004")); /*Segun catalogo 14*/
				totalMonedaAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "TOTAL VALOR DE VENTA - OPERACIONES GRATUITAS"));
				totalMonedaAdicional.setValor(new JAXBElement<>(new QName(NAMESPACE,"valor"), String.class, Util.toNumberFormat(ventaPasaje.getImportePagado(),2)));
				arrayTotalMonedaAdicional.getInformacionAdicionalTotalMonedaAdicional().add(totalMonedaAdicional);
			}
			...
			if(!(isCortesia)){
				...
				propiedadAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1000")); //Segun catalogo 15 (monto en letras)
				propiedadAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "MONTO EN LETRAS"));
				propiedadAdicional.setValue(new JAXBElement<>(new QName(NAMESPACE,"value"), String.class, getMontoLetras(venta.getMontoTotal(), venta.isTipoMonedaSoles())));
				arrayPropiedadAdicional.getInformacionAdicionalPropiedadAdicional().add(propiedadAdicional);
			}else{
				InformacionAdicionalPropiedadAdicional propiedadAdicional= new InformacionAdicionalPropiedadAdicional();
				propiedadAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1002")); //Segun catalogo 15 (monto en letras)
				propiedadAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "TRANSFERENCIA GRATUITA"));
				propiedadAdicional.setValue(new JAXBElement<>(new QName(NAMESPACE,"value"), String.class, "TRANSFERENCIA GRATUITA DE UN BIEN Y/O SERVICIO PRESTADO GRATUITAMENTE"));
				arrayPropiedadAdicional.getInformacionAdicionalPropiedadAdicional().add(propiedadAdicional);
			}

			InformacionAdicional informacionAdicional= new InformacionAdicional();
			informacionAdicional.setTotalesMonedaAdicional(new JAXBElement<>(new QName(NAMESPACE,"TotalesMonedaAdicional"), ArrayOfInformacionAdicionalTotalMonedaAdicional.class, arrayTotalMonedaAdicional));
			informacionAdicional.setPropiedadesAdicionales(new JAXBElement<>(new QName(NAMESPACE,"PropiedadesAdicionales"), ArrayOfInformacionAdicionalPropiedadAdicional.class, arrayPropiedadAdicional));

			venta.setInformacionAdicional(new JAXBElement<>(new QName(NAMESPACE,"informacionAdicional"), InformacionAdicional.class,informacionAdicional));
...
//					 "[FECHA:"+(ventaPasaje.getFechaPartida()!=null?Constantes.FORMAT_DATE.format(ventaPasaje.getFechaPartida()):"")+"] [HORA:"+(ventaPasaje.getHoraPartida()!=null?ventaPasaje.getHoraPartida().trim():"")+"]";
		...
		detalleVenta.setUnidadMedida(new JAXBElement<>(new QName(NAMESPACE,"unidadMedida"), String.class, "NIU"));
		detalleVenta.setDescripcion(new JAXBElement<>(new QName(NAMESPACE,"descripcion"), String.class, descripcionPrincipal));
		...
		if(!(isCortesia)){
			if(ventaPasaje.getIgv()!=null && ventaPasaje.getIgv()>0.00){
				...
				detalleVenta.setCodigoAfectacionIgv(new JAXBElement<>(new QName(NAMESPACE,"codigoAfectacionIgv"), String.class, "10")); //-->Gravado - Operacion onerosa - Afectacion al igv (Cat. 7)
				detalleVenta.setCodigoTipoPrecio(new JAXBElement<>(new QName(NAMESPACE,"codigoTipoPrecio"), String.class, "01")); // Precio Unitario (incluye Igv) -Tipo de precio de venta unitario (Cat. 16)
			}else{
				/*Venta Exonerada*/
				...
				detalleVenta.setCodigoAfectacionIgv(new JAXBElement<>(new QName(NAMESPACE,"codigoAfectacionIgv"), String.class, "20")); //Exonerado - Operacion Onerosa - Afectacion al igv (Cat. 7)
				detalleVenta.setCodigoTipoPrecio(new JAXBElement<>(new QName(NAMESPACE,"codigoTipoPrecio"), String.class, "01")); // Precio Unitario (incluye Igv) -Tipo de precio de venta unitario (Cat. 16)
			}
		}else{
			/*Si es CORTESIA*/
			...
			detalleVenta.setCodigoAfectacionIgv(new JAXBElement<>(new QName(NAMESPACE,"codigoAfectacionIgv"), String.class, "20")); //Exonerado - Operacion Onerosa - Afectacion al igv (Cat. 7)
			detalleVenta.setCodigoTipoPrecio(new JAXBElement<>(new QName(NAMESPACE,"codigoTipoPrecio"), String.class, "02")); // Valor referencial unitario en operaciones no onerosas - Tipo de precio de venta unitario (Cat. 16)
		}
		return detalleVenta;
	}
	...
	private static Nota createNota(VentaPasaje notaCredito, boolean isReembioSoporte){
		try {
			...
			DocumentoReferencia documentoReferencia= new DocumentoReferencia();
			documentoReferencia.setNumeroDocumento(new JAXBElement<>(new QName(NAMESPACE, "NumeroDocumento"), String.class, ventaRef.getNumeroBoleto()));
			documentoReferencia.setTipoComprobante(new JAXBElement<>(new QName(NAMESPACE, "TipoComprobante"), String.class,tipoComprobanteRef));
			documentoReferencia.setFechaDocumento(new JAXBElement<>(new QName(NAMESPACE, "FechaDocumento"), String.class,FORMAT_DATE.format(ventaRef.getFechaLiquidacion())));
...
//			Date date=Constantes.FORMAT_DATE_TIME_24H.parse(MyTime.dateTimeServer());
			...
			nota.setNumeroCorrelativo(new JAXBElement<>(new QName(NAMESPACE, "numeroCorrelativo"), String.class,notaCredito.getNumeroBoleto().split("-")[1]));
			nota.setFechaEmision(new JAXBElement<>(new QName(NAMESPACE, "fechaEmision"), String.class,fechaEmision));
			nota.setCodigoTipoNota(new JAXBElement<>(new QName(NAMESPACE, "codigoTipoNota"), String.class,notaCredito.getTipoNota().getCodigoEquivalenteSunat()));
			nota.setDescripcionTipoNota(new JAXBElement<>(new QName(NAMESPACE, "descripcionTipoNota"), String.class,notaCredito.getTipoNota().getEquivalenteSunat()));
			nota.setTipoComprobanteID(new JAXBElement<>(new QName(NAMESPACE, "tipoComprobanteID"), String.class,(notaCredito.getTipoComprobante().getId().intValue()==Constantes.ID_TIPCOM_NOTA_CREDITO?FE_TIPCOM_NOTA_CREDITO:FE_TIPCOM_NOTA_DEBITO)));
			nota.setDescripcionSustento(new JAXBElement<>(new QName(NAMESPACE, "descripcionSustento"), String.class,notaCredito.getTipoNota().getMovimiento()));
			...
			nota.setUsuarioInsercion(new JAXBElement<>(new QName(NAMESPACE, "usuarioInsercion"), String.class,notaCredito.getUsuarioInsercion()));
			nota.setUsuarioModificacion(new JAXBElement<>(new QName(NAMESPACE, "usuarioModificacion"), String.class,notaCredito.getUsuarioModificacion()));
			...
			totalMonedaAdicional.setValor(new JAXBElement<>(new QName(NAMESPACE,"valor"), String.class, Util.toNumberFormat(nota.getSubtotal(),2))); /*(no incluye impuesto)*/
			arrayTotalMonedaAdicional.getInformacionAdicionalTotalMonedaAdicional().add(totalMonedaAdicional);
			...
			propiedadAdicional.setCodigo(new JAXBElement<>(new QName(NAMESPACE,"codigo"), String.class, "1000")); //Segun catalogo 15 (monto en letras)
			propiedadAdicional.setNombre(new JAXBElement<>(new QName(NAMESPACE,"nombre"), String.class, "MONTO EN LETRAS"));
			propiedadAdicional.setValue(new JAXBElement<>(new QName(NAMESPACE,"value"), String.class, getMontoLetras(nota.getTotal(), isMonedaSoles)));
			arrayPropiedadAdicional.getInformacionAdicionalPropiedadAdicional().add(propiedadAdicional);
			...
			nota.setInformacionAdicional(new JAXBElement<>(new QName(NAMESPACE,"informacionAdicional"), InformacionAdicional.class,informacionAdicional));
