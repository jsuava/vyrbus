...
import pe.itsb.vyrbus.service.exceptions.PorcentajeDescuentoNullException;
...
import pe.itsb.vyrbus.service.exceptions.TipoFormaPagoException;
...
//		Date fechaCaducidad = Constantes.FORMAT_DATE.parse(dbFechaInicio.getText());
	 ...
	 */
	/**
	 * Pasajero Nuevo o edisi�n del mismo.
	 *
	 * @throws Exception
	 */
...
//				lbPaxfri.setValue("");
	...
	/**
	 * Activa o Inactiva el bot�n Nuevo pasajero
	 *
	 * @param activar
	 */
	...
	/**
	 * Activa o inactiva el bot�n Editar Pasajero.
	 *
	 * @param activar
	 */
...
//		grid.appendChild(columns);
		...
		Div div= new Div();
		div.setAlign("center");
		Label label= new Label("Debe de ingresar el Password de autorizaci�n para la emisi�n de la Cortersia");
