...
import pe.itsb.vyrbus.service.exceptions.BusNullException;
import pe.itsb.vyrbus.service.exceptions.CopilotoNullException;
import pe.itsb.vyrbus.service.exceptions.DuplicateSeatException;
import pe.itsb.vyrbus.service.exceptions.EdicionNoPermitidaException;
import pe.itsb.vyrbus.service.exceptions.ItinerarioException;
import pe.itsb.vyrbus.service.exceptions.PilotoNullException;
import pe.itsb.vyrbus.service.exceptions.PilotosIgualesException;
...
//			HRE hre= ServiceLocator.getHREManager().buscarHREEmitida(Constantes.FORMAT_DATE.format(programacionServicio.getItinerario().getFechaPartida()), ((Bus)cmbbus.getSelectedItem().getValue()).getCodigo());
	...
	/**
	 * Cancela la Operacion de la Programaci�n.
	 * @throws Exception
	 */
...
//			programacionServicio.setTripulante(tripulante);
			...
			//Cuando los metodos de validacion con el WSMTC encuentran algun error y el rol es super usuario, permitira omitir tal validaci�n y continuar con la programacion del servicio.
			if(messageWSMTC!=null){
...
//			HRE hre= ServiceLocator.getHREManager().buscarHREEmitida(Constantes.FORMAT_DATE.format(programacionServicio.getItinerario().getFechaPartida()), ((Bus)cmbbus.getSelectedItem().getValue()).getCodigo());
	...
	/**
	 * Cierra la Venta de Programaci�n.
	 */
	public void cerrar(){
		closeTabWindow();
	}
	...
	public void onNuevaProgramacion() throws Exception{
		try{
			if (listboxItinerarios.getItems().size() >0  && listboxItinerarios.getSelectedIndex() >=0){
				...
				onChangePrevioProgramacion(); /*Carga el Previo de la programaci�n*/
				habilitaControlesIngresoDatos(false);
	...
	/**
	 * Busqueda de Itinerarios para generar la Programaci�n o para recuperar una Programaci�n.
	 * @throws Exception
	 */
	...
	/**
	 * Carga lista de Itinerarios en el ListBox, seg�n la busqueda realizado.
	...
	/**
	 * Habilita o desabilita ingreso de datos para la programaci�n.
	...
	/**
	 * Carga c�digos de los Buses en el ComboBox
	 * @throws Exception
	 */
		...
		if (cmbbus.getSelectedIndex() >=0){
			if (cmbbus.getSelectedItem().getValue() instanceof Bus){
				...
				if (busProgramado){
					...
					Messagebox.show("El Bus seleccionado ya �sta Programado para esta fecha. "+
	...
	/**
	 * Carga los buses seg�n el Servicio del Itinerario seleccionado.
	 * @param servicio
	 * @throws Exception
	 */
	...
	/**
	 * Carga el Previo de la Programaci�n
	 */
	...
	/**
	 * Limpia el Previo de la Programaci�n.
	 */
...
//		lblHoraLlegada.setValue("");
	...
	public void onClickLisBox() throws Exception{
		...
		/*Carga buses seg�n el tipo de servicio del Itinerario seleccionado.*/
