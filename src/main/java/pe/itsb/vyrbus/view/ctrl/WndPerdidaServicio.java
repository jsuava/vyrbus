...
//		wndPerdidaServicio=(Window)this.getFellow("wndPerdidaServicio");
	...
	/**
	 * Realiza la validacï¿½n para ver si al boleto se le puede aplicar el proceso de Perdida de Servicio.
	 * @param idVenta	: Identificador de la venta.
	 * @param createVentanaDevolucion	: Indica si debe crearse la Ventana para aplicar la pï¿½rdida de servicio.
	 */
...
//				throw new ManifiestoImpresoException();
	...
	/**
	 * Realiza la creaciï¿½n de la Ventana para marcar el boleto como perdida de Servicio.
