 ...
 * Descripci�n	: Clase que se utilizara para la confirmaci�n de Reservas y para las Fechas Abiertas.
...
import pe.itsb.vyrbus.view.ui.IConfirmacion;
...
//					cmbTipoComprobante.setSelectedItem(comboitem);
	...
	//						//realiza el descuento seg�n el porcentaje de descuento que contenga la cortesia
	//
	//						if(cortesia!=null){
...
//			Messagebox.show(msg, DlgMessage.NOMBREAPLICACION, DlgMessage.BTN_YESNO, Messagebox.QUESTION, EventSaveClient(oCliente));
	...
	/**
	 * Realiza una validaci�n del Tipo de Forma de Pago, para habilitar o
