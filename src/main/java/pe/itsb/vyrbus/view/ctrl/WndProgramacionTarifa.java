...
//		cmdQuitarTramo=(Button)this.getFellow("cmdQuitarTramo");
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onNew()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onSearch()
	 */
	@Override
...
//							sServicio,tipoDeItinerario, criterioOrden));
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onRefresh(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onModify(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onCancel(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onSave(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onDelete(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onPrint(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onExport(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onHelp()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see pe.itsb.vyrbus.view.ui.IOpcionesMantenimiento#onChangeTab(int)
	 */
	@Override
