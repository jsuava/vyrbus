...
import pe.itsb.vyrbus.service.exceptions.OpcionMenuNombreObjetoNullException;
import pe.itsb.vyrbus.service.exceptions.OpcionMenuOrdenNullException;
import pe.itsb.vyrbus.service.exceptions.OpcionMenuPadreNullException;
import pe.itsb.vyrbus.service.exceptions.OpcionMenuUrlNullException;
...
public class WndOpcionMenu extends WndOpcionesMantenimiento {
	...
	public void onSearch() throws Exception {
		...
		oWndFiltrar.addParameter("Denominaci�n", OpcionMenu.class);
		...
		oWndFiltrar.addEventListener(pe.itsb.vyrbus.view.ui.Events.ON_FILTER, new EventListener<Event>() {
			...
			public void onEvent(Event event) throws Exception {
				...
				if (oWndFiltrar.getParameterValue("Denominaci�n") instanceof OpcionMenu){
					OpcionMenu opcionMenu = new OpcionMenu();
					opcionMenu.setId(((OpcionMenu) oWndFiltrar.getParameterValue("Denominaci�n")).getId());
