...
import pe.itsb.vyrbus.service.exceptions.TipoCambioNullException;
import pe.itsb.vyrbus.service.exceptions.TipoCobranzaNullException;
import pe.itsb.vyrbus.service.exceptions.TipoMonedaNullException;
...
//			DlgMessage.information(Messages.getString("WndFacturacionServicios.information.noClienteEncontrado"));
	...
	private Window createVentanaAnulacion(final VentaPasaje ventaOriginal){
		...
		row=new Row();
		row.setSpans("1,4");
		label = new Label("MOTIVO ANULACI�N (*) :");
		row.appendChild(label);
