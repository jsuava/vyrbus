...
import pe.itsb.vyrbus.service.exceptions.ParametrosException;
...
//		parametros=(Parametros) getDesktop().getSession().getAttribute(Constantes.ATRIBUTO_PARAMETROS);
		...
		//Deshabilita los campos en los par�metros - jabanto - 17/11/2022
...
//	}
	...
	/**
	 * Optiene los IDs del usuarios, seg�n el parametro indicado
