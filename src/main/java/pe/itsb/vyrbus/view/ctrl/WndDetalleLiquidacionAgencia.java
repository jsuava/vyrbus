...
//				DlgMessage.information("Debe de seleccionar un opci�n para la emsi�n de Notas de Cr�dito.");
//				return;
//			}else if (lstbxVentasReimpresion.getSelectedCount()==0){
//				DlgMessage.information("Debe de seleccionar los comprobantes a quienes se la va a aplicar Notas de Cr�dito.");
//				return;
//			}else if(lstbxVentasReimpresion.getSelectedCount()>30){
//				DlgMessage.information("Solo es posible la emisi�n masiva de Notas de Cr�dito de hasta 30 comprobantes seleccionados");
//				return;
//			}else{
...
//					DlgMessage.information("Debe tener una Liquidaci�n abierta");
//					return;
//				}else{
//					Date fechaActual= Constantes.FORMAT_DATE.parse(MyTime.dateTimeServer());
//					if(fechaLiquidacion.getTime()!=fechaActual.getTime()){
//						DlgMessage.information("La fecha de su Liquidaci�n es diferente a la Actual, Ci�rrela y apertura una nueva.");
//						return;
//					}
//				}
//			}
...
//
//							DlgMessage.information("El proceso termin� correctamente");
//						}
//					} catch (Exception e2) {
//						e2.printStackTrace();
