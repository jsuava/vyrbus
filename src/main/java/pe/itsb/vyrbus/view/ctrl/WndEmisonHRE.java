...
import pe.itsb.vyrbus.model.bean.NumeroHojaRutaID;
...
import pe.itsb.vyrbus.service.util.WSMTC;
...
//			Agencia agenciaPartida=(Agencia)cmbAgencia.getSelectedItem().getValue();
			...
			for(ProgramacionServicio programacion: lstProgramacion){
				...
				if(rdSalida.isChecked()){
					...
					/**
					 * Cuando la hoja de ruta a�n no ha sido emitida
					 */
					if(!(isHreEmitida)){
						Toolbarbutton btnGenerarHRE=new Toolbarbutton();
						btnGenerarHRE.setImage("/resources/mp_generarhre.png");
						btnGenerarHRE.setTooltiptext("Generar Hoja de Ruta Electr�nica.");
						...
						if(!(dFechaHoraActual.getTime()>=dfechaHoraPartida.getTime())){
							...
							btnGenerarHRE.setTooltiptext("Se habilitar� "+tipempoEmisonHRE.toString()+" Minutos antes de la hora de partida del Servicio.");
						...
						/*Deshabilita la emision del Manifiesto electr�nico*/
						btnGenerarME.setImage("/resources/mp_generarmeDisabled.png");
						btnGenerarME.setDisabled(true);
						btnGenerarME.setTooltiptext("Se habilitar� una vez emitida la HRE.");
						cell=new Listcell();
						...
						btnPrintHRE.setTooltiptext("Imprimir Hoja de Ruta Electr�nica.");
						...
						btnPrevioPrintHRE.setTooltiptext("Vista preliminar de la Hoja de Ruta Electr�nica.");
						...
						btnPrevioPrintHRE.addEventListener(Events.ON_CLICK,new EventListener<Event>() {
							...
							public void onEvent(Event event) throws Exception {
								try {
									/*Procesa previsualizaci�n de la impresion de la HRE*/
...
//							   getRol().getId().intValue()==Constantes.ID_ROL_GERENCIA_COMERCIAL
						   ...
						   &&
							...
							btnAnularHre.setTooltiptext("Anular Hoja de Ruta Eletr�nica.");
						...
						if(programacion.isMEE()==null || !programacion.isMEE()){
							...
							btnGenerarME.setTooltiptext("Generar Manifiesto Electr�nico.");
					...
					lshdHRE.setLabel("EMISI�N HRE");
					lshdHRE.setTooltiptext("Emision/Impresi�n de HRE.");
...
//		}
	 ...
	 * @param numeroHRE			: Numero de hoja de ruta. (para el caso de la impresion y previsualizaci�n de la hoja de ruta, asi como para la generacion del ME)
	 * @param pilotoIniciaConduccion : Piloto que inicia la conducci�n. (Solo la generaci�n de la Hoja de Ruta Electronica)
	 * @throws Exception
	 */
...
//		//===================================================================================================================
//		/*Valida si el servicio a�n no tiene HRE generada*/
...
//			String file = Constantes.URL_FORMATOS_HRE+namefile+".txt";
			...
			win.setAttribute("msg", "Imprimiendo Hoja de Ruta El�ctronica... ");
...
//		iFrame.setSrc(Constantes.URL_FORMATOS_HRE + namefile+".txt");
	 ...
	 * @param numeroHRE : N�mero de la hoja de ruta.
	 * @throws Exception
	 */
	...
	*/
	...
	private  Window createWindowsGenerarHRE(final ProgramacionServicio programacionServicio) throws Exception {
		...
		window.setTitle("GENERAR LA HOJA DE RUTA ELECTR�NICA (HRE)");
		...
		row.setSpans("1,2");
		label =  new Label();
		label.setValue("PILOTO QUE INICIA LA CONDUCCI�N :");
	...
	private  Window createWindowsfinalizarHRE(ProgramacionServicio programacionServicio) throws Exception {
		...
		window.setWidth("440px");
		window.setBorder(true);
		window.setTitle("Finalizar Hoja de Ruta Electr�nica (HRE)");
