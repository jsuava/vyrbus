...
//					c_inicio=vp.getNumeroBoleto();
					...
					/*Obtiene el ultimo n�mero segun el rango configurador en la variable "parametro" y valida los correlativos faltantes*/
					String c_serieBack="";
...
//		btnAceptar.setMold("trendy");
	 ...
	 * @param window 			: objeto window del cual esta llamando a este m�todo.
	 * @throws Exception
	 */
...
//		}
		...
		/*Solicita confirmaci�n del usuario para la impresion de la liquidacion*/
...
//			win.setAttribute("msg", "Imprimiendo la Liquidaci�n de Turno... ");
