...
import pe.itsb.vyrbus.service.mappers.ButtonGenerarMapa;
import pe.itsb.vyrbus.service.mappers.Cafeteria;
import pe.itsb.vyrbus.service.mappers.Coordenada;
import pe.itsb.vyrbus.service.mappers.ElementoBus;
import pe.itsb.vyrbus.service.mappers.Monitor;
import pe.itsb.vyrbus.service.mappers.Papelera;
...
//		habilitarSegundoPiso(false);
	...
	/**
	 * Realiza la asignaci�n de informaci�n a los controles.
...
//					nAsientos = servicio.getNumeroAsientosPiso2();
	...
	/**
	 * Permite la grabaci�n del Mapa del Bus.
	 */
