...
import pe.itsb.vyrbus.view.ctrl.WndLogin;
...
public abstract class WndBase extends Window implements IBase, BeforeCompose, AfterCompose {
	...
	/**
	 * Metodo ZK Framework que se ejecuta antes de componer la p�gina.
	 */
	@Override
	...
	/**
	 * Metodo ZK Framework que se ejecuta despues de componer la p�gina.
	 */
	@Override
