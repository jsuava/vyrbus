...
import com.cystesoft.vyrbus.model.dao.SolicitudCarteraDAO;
...
public class SolicitudCarteraDAOImpl extends GenericDAOImpl implements SolicitudCarteraDAO {
	...
	public Double baseHistoricaCliente(Long idCliente) throws Exception {
		...
		Integer iNumMeses=(Constantes.CALCULO_BASE_HISTORICA/30);
...
//		
		...
		log.info(sql);
		List<?> result = getSession().createSQLQuery(sql).list();
		List<SolicitudCartera> lstResult = new ArrayList<SolicitudCartera>();
