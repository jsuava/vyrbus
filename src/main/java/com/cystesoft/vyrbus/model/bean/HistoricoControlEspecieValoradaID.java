 ...
 */
public class HistoricoControlEspecieValoradaID implements java.io.Serializable {
	 ...
	 */
	public HistoricoControlEspecieValoradaID(Integer idTipoComprobante, Integer idUsuarioHardware) {
		super();
