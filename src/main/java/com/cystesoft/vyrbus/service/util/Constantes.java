...
public class Constantes {
	 ...
	 */
	public static final String SYSTEM_VERSION = "Versi�n 3.4.7";
	...
	/**
	 * Constante para la Acci�n Modificar
	 * @see WndOpcionesMantenimiento#onCancel(int)
	 * @see WndOpcionesMantenimiento#onSave(int)
	 */
	...
	public static final int ASIENTO_EMBARCADO = 4;
	public static final int ASIENTO_PENDIENTE_EMBARQUE = 5;
...
//	public static final String SERVER_HOST = "170.0.233.156:8080";
	...
	/*Constante dias del anio expresado en d�as*/
...
//	public static final int ID_FORPAG_PREPAGADO=8;
	 ...
	 * Ejemplo si la hora de embarque del itinerario es a las: 12:00, se puede hacer hastas las 12:30 como m�ximo
	 */
...
//	public static final int TIEMPO_EXPIRA_RESERVA = 6;
	/**
	 * Tiempo limite para poder aceptar la postergaci�n del boleto.
	 */
...
//	public static final int PUNTOS_GANADOS_X_PAXFREE = 5;
     ...
     * la fecha de su cumplea�os. Por defecto es 60 dias
	 */
...
//	public static final int DIAS_CADUCAN_PUNTOS=365;
	/**
	 * Indica el porcentaje para la alerta a abastecimientos para el env�o de especies valoradas a la Agencia.
	 */
...
//	public static final double ALERTAR_ENVIO_MANIFIESTOS=85.0;
	...
	/**
	 * IP del proxy que utilizara el sistema para establecer la conexi�n con el WS del MTC.
	 */
