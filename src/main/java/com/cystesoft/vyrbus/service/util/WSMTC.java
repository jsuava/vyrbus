...
public class WSMTC {
	...
	private static String MESSAGE_NULL_MTC="El MTC ha encontrado errores en la validación, pero este no ha retornado ningún Mensaje.";
	 ...
	 * @param NumeroDocumento	: Número de Documento del Conductor.
	...
	public static String validarConductor(String tipoDocumento,String NumeroDocumento, Integer tipoConductor) throws WSMTCExcepcion, Exception{
		try {
			...
			String message="El MTC reporta lo siguiente sobre el "+stipoConductor+", por lo que éste se encuentra INABILITADO para conducir:\n"+wse.getMessage();
...
//			throw new WSMTCExcepcion(e.getMessage());
	 ...
	 * @param numeroPlaca : Número de la plaza del Vehiculo
...
//	}
	 ...
	 * @return Tipo documento según MTC
	 * @throws Exception
	 */
	...
	private static Boolean permitirAlRolOmicionErres(String exceptionMessage){
		if( exceptionMessage==null){
			...
			//Validación cuando el servicio web retorna una exception desconocida.
...
//			mensaje+="La reactivación se realizará de forma automática, apenas se obtenga respuesta de este Método.\n";
			...
			//Envia E-Mail
			mensaje+="\n\n NOTA: [Este buzon es de envio automático, por favor no responda.]";
			Sendmail.enviaEmail(mensaje,"Desactivación automática de Validaciones y envío de alertas", window);
		}
	}
