...
public interface ItinerarioManager {
	 ...
	 * @throws Exception
	 */
	public ArrayList<Itinerario> buscarPorX(TreeMap<String, Object> criteriosBusqueda, List<String> criteriosOrdenar)throws Exception;
	/**
	 * Busca Itinerarios por ID del itinerario
