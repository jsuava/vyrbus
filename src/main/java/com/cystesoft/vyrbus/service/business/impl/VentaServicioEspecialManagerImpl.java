...
import com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager;
...
public class VentaServicioEspecialManagerImpl implements VentaServicioEspecialManager {
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#buscarPorEstadoRegistro(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#buscarPorX(java.util.TreeMap, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#buscarPorId(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#guardar(com.cystesoft.vyrbus.model.bean.VentaServicioEspecial)
	 */
	@Override
	@Transactional
...
//		}
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#actualizar(com.cystesoft.vyrbus.model.bean.VentaServicioEspecial)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cystesoft.vyrbus.service.business.VentaServicioEspecialManager#inactivar(long)
	 */
	@Override
