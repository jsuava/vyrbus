 ...
 *
 */
public interface ProgramacionServicioManager {

	/**
	 * Guarda Programacion
	 * @param 	: Clase ProgramacionServicios
	 * @return 	: Retorna 1 si la operacion fue correcta, si no retorna -1.
	 * @throws Exception
	 */
 ...
 */
	 ...
	 * @param Servicio		: Indentificador unico del Servicio
