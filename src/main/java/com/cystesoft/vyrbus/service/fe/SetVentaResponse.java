 ...
 *       &lt;sequence>
 *         &lt;element name="setVentaResult" type="{http://schemas.datacontract.org/2004/07/FEService.Util}Result" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "setVentaResult" })
@XmlRootElement(name = "setVentaResponse")
public class SetVentaResponse {

	@XmlElementRef(name = "setVentaResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
	protected JAXBElement<Result> setVentaResult;
