 ...
 * 
 */
@WebServiceClient(name = "MEFEService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://192.168.0.32:8085/MEFEService.svc?wsdl")
public class MEFEService extends Service {
	...
	static {
		...
		try {
			...
			url = new URL(baseUrl, "http://192.168.0.32:8085/MEFEService.svc?wsdl");
		} catch (MalformedURLException e) {
			logger.warning(
					"Failed to create URL for the wsdl Location: 'http://192.168.0.32:8085/MEFEService.svc?wsdl', retrying as a local file");
