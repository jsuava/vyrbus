 ...
 * 
 */
@WebServiceClient(name = "MEFEService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://119.8.145.122:8085/MEFEService.svc?wsdl")
public class MEFEService extends Service {
	...
	static {
		...
		try {
			...
			url = new URL(baseUrl, "http://119.8.145.122:8085/MEFEService.svc?wsdl");
