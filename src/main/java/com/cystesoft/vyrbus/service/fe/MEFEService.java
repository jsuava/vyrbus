	...
	static {
		...
		try {
			...
			baseUrl = com.cystesoft.vyrbus.service.fe.MEFEService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://localhost:59155/MEFEService.svc?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:59155/MEFEService.svc?wsdl', retrying as a local file");
