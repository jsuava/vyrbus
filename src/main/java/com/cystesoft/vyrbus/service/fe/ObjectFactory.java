...
public class ObjectFactory {
	...
	public JAXBElement<DocumentoReferencia> createDocumentoReferencia(DocumentoReferencia value) {
		return new JAXBElement<>(_DocumentoReferencia_QNAME, DocumentoReferencia.class, null, value);
	}
	...
	public JAXBElement<DetalleVenta> createDetalleVenta(DetalleVenta value) {
		return new JAXBElement<>(_DetalleVenta_QNAME, DetalleVenta.class, null, value);
	}
	...
	public JAXBElement<RetencionDetalleInp> createRetencionDetalleInp(RetencionDetalleInp value) {
		return new JAXBElement<>(_RetencionDetalleInp_QNAME, RetencionDetalleInp.class, null, value);
	}
	...
	public JAXBElement<Nota> createNota(Nota value) {
		return new JAXBElement<>(_Nota_QNAME, Nota.class, null, value);
	}
	...
	public JAXBElement<DocumentCDR> createDocumentCDR(DocumentCDR value) {
		return new JAXBElement<>(_DocumentCDR_QNAME, DocumentCDR.class, null, value);
	}
	...
	public JAXBElement<InformacionAdicional> createInformacionAdicional(InformacionAdicional value) {
		return new JAXBElement<>(_InformacionAdicional_QNAME, InformacionAdicional.class, null,
				value);
	}
	...
	public JAXBElement<ArrayOfDetalleVenta> createArrayOfDetalleVenta(ArrayOfDetalleVenta value) {
		return new JAXBElement<>(_ArrayOfDetalleVenta_QNAME, ArrayOfDetalleVenta.class, null, value);
	}
	...
	public JAXBElement<InformacionCredito> createInformacionCredito(InformacionCredito value) {
		return new JAXBElement<>(_InformacionCredito_QNAME, InformacionCredito.class, null, value);
	}
	...
	public JAXBElement<InformacionAdicionalPropiedadAdicional> createInformacionAdicionalPropiedadAdicional(
		...
		return new JAXBElement<>(_InformacionAdicionalPropiedadAdicional_QNAME,
	...
	public JAXBElement<Cliente> createCliente(Cliente value) {
		return new JAXBElement<>(_Cliente_QNAME, Cliente.class, null, value);
	}
	...
	public JAXBElement<ArrayOfInformacionCredito> createArrayOfInformacionCredito(ArrayOfInformacionCredito value) {
		return new JAXBElement<>(_ArrayOfInformacionCredito_QNAME,
	...
	public JAXBElement<ArrayOfRetencionDetalleInp> createArrayOfRetencionDetalleInp(ArrayOfRetencionDetalleInp value) {
		return new JAXBElement<>(_ArrayOfRetencionDetalleInp_QNAME,
	...
	public JAXBElement<RetencionInp> createRetencionInp(RetencionInp value) {
		return new JAXBElement<>(_RetencionInp_QNAME, RetencionInp.class, null, value);
	}
	...
	public JAXBElement<Result> createResult(Result value) {
		return new JAXBElement<>(_Result_QNAME, Result.class, null, value);
	}
	...
	public JAXBElement<Venta> createVenta(Venta value) {
		return new JAXBElement<>(_Venta_QNAME, Venta.class, null, value);
	}
	...
	public JAXBElement<ArrayOfRetencionInp> createArrayOfRetencionInp(ArrayOfRetencionInp value) {
		return new JAXBElement<>(_ArrayOfRetencionInp_QNAME, ArrayOfRetencionInp.class, null, value);
	}
	...
	public JAXBElement<DocumentoBaja> createDocumentoBaja(DocumentoBaja value) {
		return new JAXBElement<>(_DocumentoBaja_QNAME, DocumentoBaja.class, null, value);
	}
	...
	public JAXBElement<String> createClienteNombres(String value) {
		return new JAXBElement<>(_ClienteNombres_QNAME, String.class, Cliente.class, value);
	}
	...
	public JAXBElement<String> createClienteDireccion(String value) {
		return new JAXBElement<>(_ClienteDireccion_QNAME, String.class, Cliente.class, value);
	}
	...
	public JAXBElement<String> createClienteNumeroDocumento(String value) {
		return new JAXBElement<>(_ClienteNumeroDocumento_QNAME, String.class, Cliente.class, value);
	}
	...
	public JAXBElement<String> createClienteTipoDocumentoID(String value) {
		return new JAXBElement<>(_ClienteTipoDocumentoID_QNAME, String.class, Cliente.class, value);
	}
	...
	public JAXBElement<String> createInformacionCreditoNroCuota(String value) {
		return new JAXBElement<>(_InformacionCreditoNroCuota_QNAME, String.class, InformacionCredito.class,
				value);
	}
	...
	public JAXBElement<String> createInformacionCreditoFechaVencimiento(String value) {
		return new JAXBElement<>(_InformacionCreditoFechaVencimiento_QNAME, String.class,
	...
	public JAXBElement<Result> createSetEnviarComprobantesSunatResponseSetEnviarComprobantesSunatResult(Result value) {
		return new JAXBElement<>(_SetEnviarComprobantesSunatResponseSetEnviarComprobantesSunatResult_QNAME,
	...
	public JAXBElement<String> createDocumentoReferenciaTipoComprobante(String value) {
		return new JAXBElement<>(_DocumentoReferenciaTipoComprobante_QNAME, String.class,
	...
	public JAXBElement<String> createDocumentoReferenciaNumeroDocumento(String value) {
		return new JAXBElement<>(_DocumentoReferenciaNumeroDocumento_QNAME, String.class,
				DocumentoReferencia.class, value);
	}
	...
	public JAXBElement<String> createDocumentoReferenciaFechaDocumento(String value) {
		return new JAXBElement<>(_DocumentoReferenciaFechaDocumento_QNAME, String.class,
				DocumentoReferencia.class, value);
	}
	...
	public JAXBElement<String> createGetRepresentacionImpresaStrRucEmpresa(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaStrRucEmpresa_QNAME, String.class,
	...
	public JAXBElement<String> createGetRepresentacionImpresaTipoComprobante(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaTipoComprobante_QNAME, String.class,
				GetRepresentacionImpresa.class, value);
	}
	...
	public JAXBElement<String> createGetRepresentacionImpresaCorrelativo(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaCorrelativo_QNAME, String.class,
				GetRepresentacionImpresa.class, value);
	}
	...
	public JAXBElement<String> createGetRepresentacionImpresaSerie(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaSerie_QNAME, String.class,
				GetRepresentacionImpresa.class, value);
	}
	...
	public JAXBElement<String> createGetRepresentacionImpresaToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class,
				GetRepresentacionImpresa.class, value);
	}
	...
	public JAXBElement<Result> createSetBajasResponseSetBajasResult(Result value) {
		return new JAXBElement<>(_SetBajasResponseSetBajasResult_QNAME, Result.class, SetBajasResponse.class,
				value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpFechaPago(String value) {
		return new JAXBElement<>(_RetencionDetalleInpFechaPago_QNAME, String.class, RetencionDetalleInp.class,
				value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpMonedaOriginal(String value) {
		return new JAXBElement<>(_RetencionDetalleInpMonedaOriginal_QNAME, String.class,
	...
	public JAXBElement<String> createRetencionDetalleInpFechaEmisonDoctRelacionado(String value) {
		return new JAXBElement<>(_RetencionDetalleInpFechaEmisonDoctRelacionado_QNAME, String.class,
				RetencionDetalleInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpMonedaPagado(String value) {
		return new JAXBElement<>(_RetencionDetalleInpMonedaPagado_QNAME, String.class, RetencionDetalleInp.class,
				value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpTipoDoctRelacionado(String value) {
		return new JAXBElement<>(_RetencionDetalleInpTipoDoctRelacionado_QNAME, String.class,
				RetencionDetalleInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpNumDoctRelacionado(String value) {
		return new JAXBElement<>(_RetencionDetalleInpNumDoctRelacionado_QNAME, String.class,
				RetencionDetalleInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpNumeroPago(String value) {
		return new JAXBElement<>(_RetencionDetalleInpNumeroPago_QNAME, String.class, RetencionDetalleInp.class,
				value);
	}
	...
	public JAXBElement<String> createRetencionDetalleInpMonedaDoctRelacionado(String value) {
		return new JAXBElement<>(_RetencionDetalleInpMonedaDoctRelacionado_QNAME, String.class,
				RetencionDetalleInp.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaDescripcionMotivo(String value) {
		return new JAXBElement<>(_DocumentoBajaDescripcionMotivo_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaUsuarioInsercion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioInsercion_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaFechaEmision(String value) {
		return new JAXBElement<>(_DocumentoBajaFechaEmision_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaUsuarioModificacion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioModificacion_QNAME, String.class, DocumentoBaja.class,
				value);
	}
	...
	public JAXBElement<String> createDocumentoBajaNumeroCorrelativo(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroCorrelativo_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaRucEmpresa(String value) {
		return new JAXBElement<>(_DocumentoBajaRucEmpresa_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaNumeroSerie(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroSerie_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaTipoDocumentoID(String value) {
		return new JAXBElement<>(_ClienteTipoDocumentoID_QNAME, String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentCDRId(String value) {
		return new JAXBElement<>(_DocumentCDRId_QNAME, String.class, DocumentCDR.class, value);
	}
	...
	public JAXBElement<String> createDocumentCDRRucEmpresa(String value) {
		return new JAXBElement<>(_DocumentoBajaRucEmpresa_QNAME, String.class, DocumentCDR.class, value);
	}
	...
	public JAXBElement<String> createDocumentCDRTicket(String value) {
		return new JAXBElement<>(_DocumentCDRTicket_QNAME, String.class, DocumentCDR.class, value);
	}
	...
	public JAXBElement<Result> createSetNotaResponseSetNotaResult(Result value) {
		return new JAXBElement<>(_SetNotaResponseSetNotaResult_QNAME, Result.class, SetNotaResponse.class, value);
	}
	...
	public JAXBElement<String> createSetEnviarComprobantesSunatRucEmpresa(String value) {
		return new JAXBElement<>(_SetEnviarComprobantesSunatRucEmpresa_QNAME, String.class,
	...
	public JAXBElement<Result> createSetResumenesResponseSetResumenesResult(Result value) {
		return new JAXBElement<>(_SetResumenesResponseSetResumenesResult_QNAME, Result.class,
	...
	public JAXBElement<Result> createSetUpdateStatusCDRResponseSetUpdateStatusCDRResult(Result value) {
		return new JAXBElement<>(_SetUpdateStatusCDRResponseSetUpdateStatusCDRResult_QNAME, Result.class,
	...
	public JAXBElement<String> createInformacionAdicionalTotalMonedaAdicionalNombre(String value) {
		return new JAXBElement<>(_InformacionAdicionalTotalMonedaAdicionalNombre_QNAME, String.class,
	...
	public JAXBElement<String> createInformacionAdicionalTotalMonedaAdicionalValor(String value) {
		return new JAXBElement<>(_InformacionAdicionalTotalMonedaAdicionalValor_QNAME, String.class,
				InformacionAdicionalTotalMonedaAdicional.class, value);
	}
	...
	public JAXBElement<String> createInformacionAdicionalTotalMonedaAdicionalCodigo(String value) {
		return new JAXBElement<>(_InformacionAdicionalTotalMonedaAdicionalCodigo_QNAME, String.class,
				InformacionAdicionalTotalMonedaAdicional.class, value);
	}
	...
	public JAXBElement<String> createSetResumenesFechaEmisionComprobantes(String value) {
		return new JAXBElement<>(_SetResumenesFechaEmisionComprobantes_QNAME, String.class, SetResumenes.class,
				value);
	}
	...
	public JAXBElement<String> createSetResumenesRucEmpresa(String value) {
		return new JAXBElement<>(_SetEnviarComprobantesSunatRucEmpresa_QNAME, String.class, SetResumenes.class,
				value);
	}
	...
	public JAXBElement<String> createSetResumenesToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetResumenes.class, value);
	}
	...
	public JAXBElement<String> createDetalleVentaCodigoProducto(String value) {
		return new JAXBElement<>(_DetalleVentaCodigoProducto_QNAME, String.class, DetalleVenta.class, value);
	}
	...
	public JAXBElement<String> createDetalleVentaCodigoTipoPrecio(String value) {
		return new JAXBElement<>(_DetalleVentaCodigoTipoPrecio_QNAME, String.class, DetalleVenta.class, value);
	}
	...
	public JAXBElement<String> createDetalleVentaUnidadMedida(String value) {
		return new JAXBElement<>(_DetalleVentaUnidadMedida_QNAME, String.class, DetalleVenta.class, value);
	}
	...
	public JAXBElement<String> createDetalleVentaCodigoAfectacionIgv(String value) {
		return new JAXBElement<>(_DetalleVentaCodigoAfectacionIgv_QNAME, String.class, DetalleVenta.class, value);
	}
	...
	public JAXBElement<String> createDetalleVentaDescripcion(String value) {
		return new JAXBElement<>(_DetalleVentaDescripcion_QNAME, String.class, DetalleVenta.class, value);
	}
	...
	public JAXBElement<DocumentoBaja> createSetBajaDocumentoDocumentoBaja(DocumentoBaja value) {
		return new JAXBElement<>(_SetBajaDocumentoDocumentoBaja_QNAME, DocumentoBaja.class,
	...
	public JAXBElement<String> createSetBajaDocumentoToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetBajaDocumento.class,
				value);
	}
	...
	public JAXBElement<Result> createBuscarDetalleComprobanteResponseBuscarDetalleComprobanteResult(Result value) {
		return new JAXBElement<>(_BuscarDetalleComprobanteResponseBuscarDetalleComprobanteResult_QNAME,
	...
	public JAXBElement<Result> createSetBajaDocumentoResponseSetBajaDocumentoResult(Result value) {
		return new JAXBElement<>(_SetBajaDocumentoResponseSetBajaDocumentoResult_QNAME, Result.class,
	...
	public JAXBElement<String> createSetBajasFechaEmisionComprobantes(String value) {
		return new JAXBElement<>(_SetResumenesFechaEmisionComprobantes_QNAME, String.class, SetBajas.class,
				value);
	}
	...
	public JAXBElement<String> createSetBajasRucEmpresa(String value) {
		return new JAXBElement<>(_SetEnviarComprobantesSunatRucEmpresa_QNAME, String.class, SetBajas.class,
				value);
	}
	...
	public JAXBElement<String> createSetBajasToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetBajas.class, value);
	}
	...
	public JAXBElement<Venta> createSetVentaVenta(Venta value) {
		return new JAXBElement<>(_SetVentaVenta_QNAME, Venta.class, SetVenta.class, value);
	}
	...
	public JAXBElement<String> createSetVentaToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetVenta.class, value);
	}
	...
	public JAXBElement<Venta> createSetNotaVentaVenta(Venta value) {
		return new JAXBElement<>(_SetVentaVenta_QNAME, Venta.class, SetNotaVenta.class, value);
	}
	...
	public JAXBElement<String> createSetNotaVentaToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetNotaVenta.class, value);
	}
	...
	public JAXBElement<Nota> createSetNotaVentaNota(Nota value) {
		return new JAXBElement<>(_SetNotaVentaNota_QNAME, Nota.class, SetNotaVenta.class, value);
	}
	...
	public JAXBElement<Result> createSetNotaVentaResponseSetNotaVentaResult(Result value) {
		return new JAXBElement<>(_SetNotaVentaResponseSetNotaVentaResult_QNAME, Result.class,
	...
	public JAXBElement<String> createRetencionInpSerie(String value) {
		return new JAXBElement<>(_RetencionInpSerie_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpTasaRetencion(String value) {
		return new JAXBElement<>(_RetencionInpTasaRetencion_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpRazonSocial(String value) {
		return new JAXBElement<>(_RetencionInpRazonSocial_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpNumeroCorrelativo(String value) {
		return new JAXBElement<>(_RetencionInpNumeroCorrelativo_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpId(String value) {
		return new JAXBElement<>(_DocumentCDRId_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<ArrayOfRetencionDetalleInp> createRetencionInpDetalleRetencion(
		...
		return new JAXBElement<>(_RetencionInpDetalleRetencion_QNAME,
	...
	public JAXBElement<String> createRetencionInpRegistroRetencion(String value) {
		return new JAXBElement<>(_RetencionInpRegistroRetencion_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpCorreo(String value) {
		return new JAXBElement<>(_RetencionInpCorreo_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpFechaEmision(String value) {
		return new JAXBElement<>(_RetencionInpFechaEmision_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpRuc(String value) {
		return new JAXBElement<>(_RetencionInpRuc_QNAME, String.class, RetencionInp.class, value);
	}
	...
	public JAXBElement<String> createRetencionInpImporteTotalRetenidoEnLetras(String value) {
		return new JAXBElement<>(_RetencionInpImporteTotalRetenidoEnLetras_QNAME, String.class,
	...
	public JAXBElement<String> createNotaUsuarioModificacion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioModificacion_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaNumeroCorrelativo(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroCorrelativo_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaRucEmpresa(String value) {
		return new JAXBElement<>(_DocumentoBajaRucEmpresa_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaHoraEmision(String value) {
		return new JAXBElement<>(_NotaHoraEmision_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<Cliente> createNotaCliente(Cliente value) {
		return new JAXBElement<>(_NotaCliente_QNAME, Cliente.class, Nota.class, value);
	}
	...
	public JAXBElement<DocumentoReferencia> createNotaDocumentoReferencia(DocumentoReferencia value) {
		return new JAXBElement<>(_NotaDocumentoReferencia_QNAME, DocumentoReferencia.class,
				Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaUsuarioInsercion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioInsercion_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaDescripcionSustento(String value) {
		return new JAXBElement<>(_NotaDescripcionSustento_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaCodigoTipoNota(String value) {
		return new JAXBElement<>(_NotaCodigoTipoNota_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaDescripcionTipoNota(String value) {
		return new JAXBElement<>(_NotaDescripcionTipoNota_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaFechaEmision(String value) {
		return new JAXBElement<>(_DocumentoBajaFechaEmision_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaTipoComprobanteID(String value) {
		return new JAXBElement<>(_NotaTipoComprobanteID_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<InformacionAdicional> createNotaInformacionAdicional(InformacionAdicional value) {
		return new JAXBElement<>(_NotaInformacionAdicional_QNAME, InformacionAdicional.class,
				Nota.class, value);
	}
	...
	public JAXBElement<String> createNotaNumeroSerie(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroSerie_QNAME, String.class, Nota.class, value);
	}
	...
	public JAXBElement<String> createSetUpdateStatusCDRToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetUpdateStatusCDR.class,
				value);
	}
	...
	public JAXBElement<DocumentCDR> createSetConsultarCDRDocumentCDR(DocumentCDR value) {
		return new JAXBElement<>(_SetConsultarCDRDocumentCDR_QNAME, DocumentCDR.class, SetConsultarCDR.class,
				value);
	}
	...
	public JAXBElement<String> createSetConsultarCDRToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetConsultarCDR.class,
				value);
	}
	...
	public JAXBElement<String> createInformacionAdicionalPropiedadAdicionalValue(String value) {
		return new JAXBElement<>(_InformacionAdicionalPropiedadAdicionalValue_QNAME, String.class,
				InformacionAdicionalPropiedadAdicional.class, value);
	}
	...
	public JAXBElement<Result> createSetVentaResponseSetVentaResult(Result value) {
		return new JAXBElement<>(_SetVentaResponseSetVentaResult_QNAME, Result.class, SetVentaResponse.class,
				value);
	}
	...
	public JAXBElement<Result> createSetConsultarCDRResponseSetConsultarCDRResult(Result value) {
		return new JAXBElement<>(_SetConsultarCDRResponseSetConsultarCDRResult_QNAME, Result.class,
	...
	public JAXBElement<String> createResultMessage(String value) {
		return new JAXBElement<>(_ResultMessage_QNAME, String.class, Result.class, value);
	}
	...
	public JAXBElement<byte[]> createResultBarcodeQR(byte[] value) {
		return new JAXBElement<>(_ResultBarcodeQR_QNAME, byte[].class, Result.class, (value));
	}
	...
	public JAXBElement<byte[]> createResultPdf(byte[] value) {
		return new JAXBElement<>(_ResultPdf_QNAME, byte[].class, Result.class, (value));
	}
	...
	public JAXBElement<ArrayOfRetencionInp> createResultRetencionesInp(ArrayOfRetencionInp value) {
		return new JAXBElement<>(_ResultRetencionesInp_QNAME, ArrayOfRetencionInp.class,
				Result.class, value);
	}
	...
	public JAXBElement<ArrayOfDetalleVenta> createResultListDetalleVenta(ArrayOfDetalleVenta value) {
		return new JAXBElement<>(_ResultListDetalleVenta_QNAME, ArrayOfDetalleVenta.class,
				Result.class, value);
	}
	...
	public JAXBElement<String> createResultCode(String value) {
		return new JAXBElement<>(_ResultCode_QNAME, String.class, Result.class, value);
	}
	...
	public JAXBElement<byte[]> createResultBarcode(byte[] value) {
		return new JAXBElement<>(_ResultBarcode_QNAME, byte[].class, Result.class, (value));
	}
	...
	public JAXBElement<byte[]> createResultBarcodeEmbarque(byte[] value) {
		return new JAXBElement<>(_ResultBarcodeEmbarque_QNAME, byte[].class, Result.class, (value));
	}
	...
	public JAXBElement<Result> createGetRepresentacionImpresaResponseGetRepresentacionImpresaResult(Result value) {
		return new JAXBElement<>(_GetRepresentacionImpresaResponseGetRepresentacionImpresaResult_QNAME,
	...
	public JAXBElement<String> createSetNotaToken(String value) {
		return new JAXBElement<>(_GetRepresentacionImpresaToken_QNAME, String.class, SetNota.class, value);
	}
	...
	public JAXBElement<Nota> createSetNotaNotaCreditoDebito(Nota value) {
		return new JAXBElement<>(_SetNotaNotaCreditoDebito_QNAME, Nota.class, SetNota.class, value);
	}
	...
	public JAXBElement<ArrayOfDetalleVenta> createVentaListDetalleVenta(ArrayOfDetalleVenta value) {
		return new JAXBElement<>(_VentaListDetalleVenta_QNAME, ArrayOfDetalleVenta.class,
				Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaNumeroPrefactura(String value) {
		return new JAXBElement<>(_VentaNumeroPrefactura_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaObservaciones(String value) {
		return new JAXBElement<>(_VentaObservaciones_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaUsuarioModificacion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioModificacion_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaNumeroCorrelativo(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroCorrelativo_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaRucEmpresa(String value) {
		return new JAXBElement<>(_DocumentoBajaRucEmpresa_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaHoraEmision(String value) {
		return new JAXBElement<>(_NotaHoraEmision_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<Cliente> createVentaCliente(Cliente value) {
		return new JAXBElement<>(_NotaCliente_QNAME, Cliente.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaGlosaRetencion(String value) {
		return new JAXBElement<>(_VentaGlosaRetencion_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaCentroCosto(String value) {
		return new JAXBElement<>(_VentaCentroCosto_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<ArrayOfInformacionCredito> createVentaInfoCreditList(ArrayOfInformacionCredito value) {
		return new JAXBElement<>(_VentaInfoCreditList_QNAME, ArrayOfInformacionCredito.class,
				Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaUsuarioInsercion(String value) {
		return new JAXBElement<>(_DocumentoBajaUsuarioInsercion_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaDireccionEmbarque(String value) {
		return new JAXBElement<>(_VentaDireccionEmbarque_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaProducto(String value) {
		return new JAXBElement<>(_VentaProducto_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaFechaEmision(String value) {
		return new JAXBElement<>(_DocumentoBajaFechaEmision_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaTipoComprobanteID(String value) {
		return new JAXBElement<>(_NotaTipoComprobanteID_QNAME, String.class, Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaNumeroSerie(String value) {
		return new JAXBElement<>(_DocumentoBajaNumeroSerie_QNAME, String.class, Venta.class, value);
	}
