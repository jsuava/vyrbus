...
public class ObjectFactory {
	...
	private final static QName _SetVentaToken_QNAME = new QName(
	...
	public JAXBElement<String> createSetVentaToken(String value) {
		return new JAXBElement<String>(_SetVentaToken_QNAME, String.class,
	...
	public JAXBElement<String> createDocumentoBajaUsuarioModificacion(
			String value) {
		return new JAXBElement<String>(_DocumentoBajaUsuarioModificacion_QNAME,
	...
	public JAXBElement<String> createDocumentoBajaRucEmpresa(String value) {
		return new JAXBElement<String>(_DocumentoBajaRucEmpresa_QNAME,
				String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaUsuarioInsercion(String value) {
		return new JAXBElement<String>(_DocumentoBajaUsuarioInsercion_QNAME,
				String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaNumeroSerie(String value) {
		return new JAXBElement<String>(_DocumentoBajaNumeroSerie_QNAME,
				String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaNumeroCorrelativo(String value) {
		return new JAXBElement<String>(_DocumentoBajaNumeroCorrelativo_QNAME,
				String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createDocumentoBajaFechaEmision(String value) {
		return new JAXBElement<String>(_DocumentoBajaFechaEmision_QNAME,
				String.class, DocumentoBaja.class, value);
	}
	...
	public JAXBElement<String> createVentaTipoComprobanteID(String value) {
		return new JAXBElement<String>(_VentaTipoComprobanteID_QNAME,
	...
	public JAXBElement<Cliente> createVentaCliente(Cliente value) {
		return new JAXBElement<Cliente>(_VentaCliente_QNAME, Cliente.class,
				Venta.class, value);
	}
	...
	public JAXBElement<String> createVentaHoraEmision(String value) {
		return new JAXBElement<String>(_VentaHoraEmision_QNAME, String.class,
				Venta.class, value);
	}
	...
	public JAXBElement<InformacionAdicional> createVentaInformacionAdicional(
			InformacionAdicional value) {
		return new JAXBElement<InformacionAdicional>(
				_VentaInformacionAdicional_QNAME, InformacionAdicional.class,
				Venta.class, value);
	}
	...
	public JAXBElement<DocumentoReferencia> createVentaDocumentoReferencia(
		...
		return new JAXBElement<DocumentoReferencia>(
				_VentaDocumentoReferencia_QNAME, DocumentoReferencia.class,
				Venta.class, value);
	}
	...
	public JAXBElement<String> createDocumentCDRRucEmpresa(String value) {
		return new JAXBElement<String>(_DocumentoBajaRucEmpresa_QNAME,
				String.class, DocumentCDR.class, value);
	}
