...
public class XlsAnulacionesPostergaciones extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		Listbox listbox = (Listbox)request.getSession().getAttribute("lbxAnulacionesPostergaciones");
        String parcialPath = (String)request.getSession().getAttribute("parcialPath");
        response.setContentType("application/vnd.ms-excel");
        response.setHeader("Content-Disposition", "attachment; filename=AnulacionesPestergaciones.xls");
