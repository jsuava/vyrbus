...
//	private static final String DEVOLUCION_80 = "DEVOLUCION AL 80%";
	...
	public void buscarVentas() throws Exception{
		...
		for(VentaPasaje ventaPasaje: listVentas){
			...
			btnDevolver.setTooltiptext("Devoluci�n Remota");
			...
			btnPostergar.setTooltiptext("Postergaci�n remota");
...
//			btnReimprimir.setTooltiptext("Reimpresi�n remota");
...
//		caption = new Caption("Informaci�n del Boleto");
...
//		caption = new Caption("Informaci�n de la Agencia remota");
//		caption.setStyle("color:#C03131");
...
//		row=new Row();
//
//		final Checkbox chbxExtempo=new Checkbox("Devoluci�n Extempor�nea");
...
//	}
	...
	private void createVentanaDevolucion(final VentaPasaje ventaOriginal) throws Exception{
		...
		groupbox = new Groupbox();
		groupbox.setClosable(false);
		caption = new Caption("Informaci�n Remota");
...
//										ServiceLocator.getVentaPasajesManager().actualizarCorrelativoComprobante(notaCredito, true);
	...
	private void createVentanaPostergacion(final VentaPasaje postergacion)throws Exception{
		...
		win.setWidth("700px");
		caption = new Caption("POSTERGACI�N", "resources/mp_calendarEnabled.png");
		win.appendChild(caption);

		groupbox.setClosable(false);
		caption = new Caption("Situaci�n Actual");
		caption.setStyle("color:#C03131");
		groupbox.appendChild(caption);
		...
		groupbox.setClosable(false);
		caption = new Caption("Informaci�n del Pago");
		caption.setStyle("color:#C03131");
		groupbox.appendChild(caption);
...
//						}
					...
					//Coloca como observaciones una glosa y es que es un cambio de nombtre o raz�n social
