...
import com.cystesoft.vyrbus.service.exceptions.NumeroSerieNoRegistradaException;
import com.cystesoft.vyrbus.service.exceptions.NumeroSerieNullException;
import com.cystesoft.vyrbus.service.exceptions.RangoEspecieValoradaRegistradaException;
...
//						}			
					...
					if( lngbxCorrelativoInicio.longValue() < especieValorada.getCorrelativoInicial().longValue())
						throw new CorrelativoException(CorrelativoException.FUERA_RANGO);
					if( lngbxCorrelativoFin.longValue() > especieValorada.getCorrelativoFinal().longValue())
						throw new CorrelativoException(CorrelativoException.FUERA_RANGO);
